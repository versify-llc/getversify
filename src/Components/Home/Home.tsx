    ...
    <Layout navClassName="nav-bg-grey" backgroundColor="var(--color-theme-lightgrey)">
        ...
        <div className="flex flex-wrap justify-center items-center pt-6">
          <div className="w-10/12 md:w-5/12">
            <div className="text-center md:text-right">
              ...
              <div className="text-body-md">Versify is available for free.</div>
      ...
      <div className="mt-4 md:mt-0">
        <h2 className="text-header-md">
          Memorization Made <span className="text-theme-green">Easier.</span>
        </h2>
        <p className="text-body-md">Start hiding God's Word in your heart today!</p>
